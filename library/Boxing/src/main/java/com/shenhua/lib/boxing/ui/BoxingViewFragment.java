...
import com.shenhua.lib.boxing.adapter.BoxingAlbumAdapter;
import com.shenhua.lib.boxing.adapter.BoxingMediaAdapter;
...
import com.shenhua.lib.boxing.widget.SpacesItemDecoration;
import com.shenhua.lib.boxing.widget.WindowManagerHelper;
...
public class BoxingViewFragment extends AbsBoxingViewFragment implements View.OnClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == IMAGE_PREVIEW_REQUEST_CODE) {
            mIsPreview = false;
            boolean isBackClick = data.getBooleanExtra(EXTRA_TYPE_BACK, false);
            List<BaseMedia> selectedMedias = data.getParcelableArrayListExtra(EXTRA_SELECTED_MEDIA);
    ...
    private class OnCameraClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (!mIsCamera) {
                mIsCamera = true;
                startCamera(getActivity(), BoxingViewFragment.this, DEFAULT_SUB_DIR);
            }
        }
    }

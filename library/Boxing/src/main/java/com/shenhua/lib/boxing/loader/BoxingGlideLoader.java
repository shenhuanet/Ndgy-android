...
package com.shenhua.lib.boxing.loader;
...
public class BoxingGlideLoader implements IBoxingMediaLoader {
    ...
    public void displayThumbnail(@NonNull ImageView img, @NonNull String absPath, int width, int height) {
        ...
        try {
            Glide.with(img.getContext()).load(path).placeholder(R.drawable.img_pic_loading_default).crossFade().centerCrop().override(width, height).into(img);

...
import com.shenhua.lib.boxing.model.BoxingBuilderConfig;
...
import com.shenhua.lib.boxing.utils.CameraPickerHelper;
...
public abstract class AbsBoxingViewFragment extends Fragment implements PickerContract.View {
    ...
    private ArrayList<BaseMedia> parseSelectedMedias(Bundle savedInstanceState, Bundle argument) {
        ...
        if (savedInstanceState != null) {
            selectedMedias = savedInstanceState.getParcelableArrayList(EXTRA_SELECTED_MEDIA);
        } else if (argument != null) {
            selectedMedias = argument.getParcelableArrayList(EXTRA_SELECTED_MEDIA);
        }
    ...
    public final AbsBoxingViewFragment setSelectedBundle(ArrayList<BaseMedia> selectedMedias) {
        ...
        if (selectedMedias != null && !selectedMedias.isEmpty()) {
            bundle.putParcelableArrayList(EXTRA_SELECTED_MEDIA, selectedMedias);
        }
        setArguments(bundle);
        return this;
    }
    ...
    public final void onSaveMedias(Bundle outState, ArrayList<BaseMedia> selected) {
        if (selected != null && !selected.isEmpty()) {
            outState.putParcelableArrayList(EXTRA_SELECTED_MEDIA, selected);
        }
    }

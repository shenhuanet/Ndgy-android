...
import com.shenhua.lib.boxing.loader.IBoxingCrop;
...
public class BoxingCrop {
    ...
    public void onStartCrop(Activity activity, Fragment fragment, @NonNull BoxingCropOption cropConfig,
        ...
        if (ensureLoader()) {
            throw new IllegalStateException("com.shenhua.lib.boxing.impl.BoxingCrop init method should be called first");
        }

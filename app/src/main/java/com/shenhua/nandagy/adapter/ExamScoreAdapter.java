 ...
 */
public class ExamScoreAdapter extends BaseRecyclerBindingAdapter<GradeScore> {

    public ExamScoreAdapter(List<GradeScore> mData) {
        super(mData);
    }
    ...
    @Override
    public void bindCustomData(BaseRecyclerBindingAdapter.RecyclerViewHolder holder, int position, GradeScore item) {

...
public abstract class BaseSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    protected static final String TYPE_NULL = " null ";// 值是NULL
    protected static final String TYPE_INT = " integer ";// 值是有符号整形，根据值的大小以1,2,3,4,6或8字节存放
    protected static final String TYPE_STRING = " text ";// 值是文本字符串，使用数据库编码（UTF-8，UTF-16BE或者UTF-16LE）存放
    protected static final String TYPE_REAL = " real ";// 值是浮点型值，以8字节IEEE浮点数存放
    protected static final String TYPE_BLOB = " blob ";// 只是一个数据块，完全按照输入存放（即没有准换）
    ...
    protected String buildCreateSQL(String[] columns, String[] types) throws Exception {
        ...
        sb = sb.append(");");
        System.out.println("shenhua sout:buildCreateSQL:" + sb);
        return sb.toString();
    }

 ...
 */
public class PullToZoomListView extends RecyclerView implements AbsListView.OnScrollListener {
    ...
    public void setmHeaderHeight(int mHeaderHeight) {
        ...
        LayoutParams lp = new LayoutParams(ConvertUtils.dp2px(mContext,

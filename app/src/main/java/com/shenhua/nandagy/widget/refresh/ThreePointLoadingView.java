package com.shenhua.nandagy.widget.refresh;
...
public class ThreePointLoadingView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mWidth = measureSize(widthMeasureSpec,
                ConvertUtils.dp2px(getContext(), 180)) + getPaddingLeft() + getPaddingRight();
        mHeight = measureSize(heightMeasureSpec,
                ConvertUtils.dp2px(getContext(), 180)) + getPaddingTop() + getPaddingBottom();
